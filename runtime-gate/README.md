...
当前层 profile 为 `mobile-runtime-inspection-v1`；`runtime-gate/scenarios.json` 当前登记 36 条 provider/consumer 语义场景，场景目录摘要由 `runtime-contract.lock.json.scenario_catalog_sha256` 固定。当前层的能力、provider runtime、协议快照和场景证据以这两份锁定文件为准。
